$(document).ready(function() {
	...
	if (currPage != null && (currPage == "login" || currPage == "register" || currPage == "about") ) {
...
function loadMenu(){
	...
	if(currentPage == "home"){
	...
	} else if (currentPage == "register" || currentPage == "login" || currentPage =="about"){
		$('.navbar-right').empty();
		...
		$('.navbar-right').append('<li><a href="#" id="aboutUs"><span class="glyphicon glyphicon-info-sign"></span> About Us</a></li>');
